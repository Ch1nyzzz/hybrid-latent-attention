...
from ouro_depth.latent.fused_history import causal_history_attention, causal_history_reference
from ouro_depth.latent.history_gemm import (
...
def test_multipass_replay_backends_agree():
    ...
    from ouro_depth.latent.sft_replay import history_options, replay_microbatch_sft_multipass
