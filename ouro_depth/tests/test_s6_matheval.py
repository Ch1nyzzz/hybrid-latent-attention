...
from ouro_depth.vllm_latent import matheval
...
def test_batched_decode_matches_serial_with_padding_stops_and_context_limit(chunk_size):
    ...
    from ouro_depth.latent.generate import LatentDecoder, BatchedLatentDecoder
...
def test_resume_keeps_completed_pairs_and_rejects_mismatch(tmp_path):
    from ouro_depth.latent.eval_resume import load_completed
