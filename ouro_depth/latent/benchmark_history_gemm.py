...
python -m ouro_depth.latent.benchmark_history_gemm ops --output ops.json
python -m ouro_depth.latent.benchmark_history_gemm model --model-path M --student S.pt \
