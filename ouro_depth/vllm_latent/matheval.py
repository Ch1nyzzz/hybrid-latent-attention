...
def main():
    ...
    # Later prompt chunks would read finalized history with lockstep readers.
    ...
    summ = {"mode": "base" if args.base else "latent", "backend": args.backend or "auto", "compile_config": args.compile_config, "chunked_prefill": False, "shard": args.shard, "n_problems": len(rows), "n_samples": args.n, "temperature": args.temperature,
