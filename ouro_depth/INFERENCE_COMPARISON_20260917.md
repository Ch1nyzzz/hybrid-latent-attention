...
- 长上下文与高并发是 S6 的收益区：8K×8 路 decode 1.93×，4K×8 路 1.36×，1K×32 路 1.24×；base 在 4K 上只能装 20 路、8K 上 10 路，S6 分别为 20 路以上直到 128 路和 108 路，端到端在这些格子为 base 的 1.2–1.4×（base 在排队/抢占）。
