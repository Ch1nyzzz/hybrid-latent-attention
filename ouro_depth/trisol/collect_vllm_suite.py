...
python ouro_depth/trisol/collect_vllm_suite.py --job 2100764456979005440 --out results/latent/lla-vllm-peak-20260918.json
python ouro_depth/trisol/collect_vllm_suite.py --log job.log --out ...        # from a saved log
