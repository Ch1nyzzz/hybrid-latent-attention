...
Usage:
    python3 ouro_depth/trisol/auto_eval_sft_watch.py --latent-job 2102290651751133184 --steps 100,200,300,400,500,600,700,800
...
mkdir -p /work/loop_scale /trisol/output/math500_evals
tar -xzf /trisol/input/models/model-0/eval-code.tar.gz -C /work/loop_scale
export PYTHONPATH=/work/loop_scale:$PYTHONPATH

cd /work/loop_scale
exec python3 -m ouro_depth.trisol.run_eval_sft_suite "$@"
"""
