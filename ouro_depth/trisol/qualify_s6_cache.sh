...
exec timeout 1800 python -m ouro_depth.latent.qualify_khop_runtime --mode opd --rollout-cache --soak-prompts 8 --soak-max-new 2048 \
 --model /trisol/input/model --student /trisol/input/models/model-0/student-600.pt \
 --data /work/expanded-corpus --output /trisol/output/qualification
