...
from hla.tests.test_s6_direct_decode import make_inputs
...
from hla.latent.history_snapshot import collect_snapshot, validate_snapshot
from hla.latent.khop_replay import khop_vjp, parallel_forward, replay_batch_khop
...
def test_opd_serving_loss_and_drift_use_sampled_labels():
    from hla.latent.decode_training import token_logp
    model, student, ids = tiny_double()
