...
from hla.latent import train_stage1_recipe as s1
from hla.latent.fkl import masked_fkl, memory_bounded_fkl
from hla.latent.batched_engine import BatchedRollingEngine
from hla.latent.corpus_index import RecordIndex
from hla.latent.generate import LatentDecoder
...
def test_stage1_relative_mse_is_microbatch_invariant():
    from hla.latent.train_stage1 import layer_losses
...
def test_serving_rejects_geometry_and_rope_mismatch():
    ...
    from hla.vllm_latent.geometry import rope_theta,validate_geometry
