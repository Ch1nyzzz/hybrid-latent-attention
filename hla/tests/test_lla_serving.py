"""``lla_layer`` against the ``hla.lla`` attention algebra on tiny Ouro: vLLM-style metadata (padded requests
...
import math
import torch
from hla.lla.attention import absorb_scores, rope_full
from hla.tests.test_lla import fit_codecs, tiny
