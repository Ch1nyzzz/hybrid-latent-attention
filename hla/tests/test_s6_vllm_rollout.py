...
from hla.latent.vllm_rollout import worker_environment
from hla.vllm_latent.rollout_worker import encode_outputs, install_student
...
def test_default_generation_routes_to_vllm_without_hf_load(tmp_path, monkeypatch):
    ...
    assert 'hla.vllm_latent.matheval' in captured['argv']
