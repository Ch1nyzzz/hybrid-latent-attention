import pytest
import torch
from hla.latent.fused_history import causal_history_reference, causal_history_attention
...
def test_causal_backward_kv_triton_cuda():
    import triton
    from hla.latent.history_kernels import causal_forward, causal_backward
