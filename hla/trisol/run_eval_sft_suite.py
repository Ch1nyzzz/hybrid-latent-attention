...
def inference_env(root: Path, work: Path, gpu: int, base: bool, attempt: int = 0):
    ...
    if base:
        ...
        env['S6_VLLM_OURO_FILE'] = str(root / 'hla/vllm_latent/ouro_latent.py')
    return env
...
def main():
    ...
    p.add_argument("--root", type=Path, default=Path("/work/hla"))
    ...
    data_path = args.root / "hla/matheval/data/math500.jsonl"
